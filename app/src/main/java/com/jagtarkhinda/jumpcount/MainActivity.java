...
public class MainActivity extends AppCompatActivity {
    ...
    public void setGoal(View view) {
        ...
        cnt.setText("0");
        cnt.setTextSize(100);
        enterGoal.setClickable(false);
        enterGoal.setEnabled(false);
    }
    ...
    public void tips(){
        ...
        tip.setText("You are fit for today. Enjoy Dieting :)");
        enterGoal.setClickable(true);
        enterGoal.setEnabled(true);
    }
}